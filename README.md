...
[![Build Status](https://travis-ci.org/Microsoft/ApplicationInsights-Go.svg?branch=master)](https://travis-ci.org/Microsoft/ApplicationInsights-Go) [![Documentation](https://godoc.org/github.com/osangenis/ApplicationInsights-Go?status.svg)](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights) [![Release](https://img.shields.io/github/release/Microsoft/ApplicationInsights-Go/all.svg)](https://github.com/osangenis/ApplicationInsights-Go/releases)
...
[telemetry client](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#TelemetryClient).

```go
import "github.com/osangenis/ApplicationInsights-Go/appinsights"
...
new [TelemetryConfiguration](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#TelemetryConfiguration)
...
The [TelemetryClient](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#TelemetryClient)
...
### Trace
[Trace telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#TraceTelemetry)
...
### Events
[Event telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#EventTelemetry)
...
[Metric telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#MetricTelemetry)
...
[pre-aggregated by the client](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#AggregateMetricTelemetry)
...
### Requests
[Request telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#RequestTelemetry)
...
### Dependencies
[Remote dependency telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#RemoteDependencyTelemetry)
...
### Exceptions
[Exception telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#ExceptionTelemetry)
...
### Availability
[Availability telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights/#AvailabilityTelemetry)
...
### Page Views
[Page view telemetry items](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights/#PageViewTelemetry)
...
[contracts.ContextTags](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights/contracts/#ContextTags)
...
[TelemetryContext](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights/#TelemetryContext)
...
import (
	...
	"github.com/osangenis/ApplicationInsights-Go/appinsights"
	"github.com/osangenis/ApplicationInsights-Go/appinsights/contracts"
)
...
### Shutdown
The Go SDK submits data asynchronously.  The [InMemoryChannel](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights/#InMemoryChannel)
...
through shutdown.
[The documentation](https://godoc.org/github.com/osangenis/ApplicationInsights-Go/appinsights#TelemetryChannel)
